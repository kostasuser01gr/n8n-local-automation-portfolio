# Screenshot Manifest: Local AI Knowledge and Document Processing Workflow
...
1. Full workflow canvas
   ...
   - Sign in locally.
   - Open workflow id/name: `portfolio-local-ai-knowledge` / `Local AI Knowledge and Document Processing Workflow`.
